# PAROL6 robot configuration and parameters
...
Joint_max_jog_speed = [1500, 3000, 3600, 7000, 7000, 18000] + [250, 500, 500, 1000, 1000, 1000]
...
def check_joint_limits(q, target_q=None, allow_recovery=True):
    ...
    for i in range(min(len(q_array), len(Joint_limits_radian))):
        ...
        # Current position limit validation
        ...
        if current_violates:
            ...
            # Recovery movement detection for limit violations
